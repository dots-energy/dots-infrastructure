...
from dots_infrastructure import PublicationDescription, HelicsFederateExecutor, HelicValueFederateInformation, generate_publications_from_value_descriptions, generate_subscriptions_from_value_descriptions, get_simulator_configuration_from_environment
...
if __name__ == "__main__":
    ...
    federate_executor = HelicsFederateExecutor(HelicValueFederateInformation(30, False, False, True, h.HelicsLogLevel.DEBUG,subscriptions_values, publication_values, battery_calculation), simulator_configuration)
